...
public class BookMapper {
    ...
    public Book toBook(BookRequest req) {
        ...
        return Book.builder().id(req.id()).title(req.title())
            .authorName(req.authorName()).isbn(req.isbn())
            .synopsis(req.synopsis()).isArchived(false)
    ...
    public BookResponse toBookResponse(Book req) {
        ...
        return BookResponse.builder().id(req.getId()).title(req.getTitle())
    ...
    public BorrowedBookResponse toBorrowedBookResponse(BookTransactionHistory req) {
        ...
        return BorrowedBookResponse.builder().id(book.getId()).title(book.getTitle())
            .authorName(book.getAuthorName()).isbn(book.getIsbn())
